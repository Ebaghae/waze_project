...
mask_1 = ~(df['label'].isna())
non_null_df = df[mask_1]

# Display summary stats of rows without null values
non_null_df.describe()


# ==> ENTER YOUR RESPONSE HERE : Comparing summary statistics of the observations with missing retention labels with those that aren't missing any values reveals nothing remarkable. The means and standard deviations are fairly consistent between the two groups.
...
null_df.value_counts('device')


# ==> ENTER YOUR RESPONSE HERE: of all 14,999 users, 447 iphone users had null values, and 253 adriod users had null values.
...
null_df.value_counts('device', normalize=True)
